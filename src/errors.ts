...
export const ErrorCodes = {
  ...
  INVALID_ENTITY_QUERY_BUILDER: "INVALID_ENTITY_QUERY_BUILDER",
  ...
  SEARCH_VECTORS_FAILED: "SEARCH_VECTORS_FAILED",
  ...
  INVALID_BASE_DELAY_MS: "INVALID_BASE_DELAY_MS",
  ...
  VECTOR_INDEX_NOT_FOUND: "VECTOR_INDEX_NOT_FOUND",
  VECTOR_INDEX_INVALID: "VECTOR_INDEX_INVALID",
  VECTOR_VALUE_INVALID: "VECTOR_VALUE_INVALID",
  VECTOR_TOP_K_INVALID: "VECTOR_TOP_K_INVALID",
  VECTOR_PARTITION_INVALID: "VECTOR_PARTITION_INVALID",
  VECTOR_CONDITION_INVALID: "VECTOR_CONDITION_INVALID",
  VECTOR_PROJECTION_INVALID: "VECTOR_PROJECTION_INVALID",
  VECTOR_RESPONSE_INVALID: "VECTOR_RESPONSE_INVALID",
  VECTOR_ENTITY_SCOPE_INVALID: "VECTOR_ENTITY_SCOPE_INVALID",
  VECTOR_COLLECTION_CONFIG_MISMATCH: "VECTOR_COLLECTION_CONFIG_MISMATCH",
} as const;
